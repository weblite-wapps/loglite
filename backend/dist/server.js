...
/*! exports used: deleteLog, fetchLogs, saveLog, saveTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_log__ = __webpack_require__(/*! ../../../models/log */ \"./models/log.js\");\n// models\n\n\nconst fetchLogs = async query => __WEBPACK_IMPORTED_MODULE_0__models_log__[\"a\" /* default */].find(query).sort({ created_at: -1 }).exec();\n/* harmony export (immutable) */ __webpack_exports__[\"b\"] = fetchLogs;\n\n\nconst saveLog = async log => new __WEBPACK_IMPORTED_MODULE_0__models_log__[\"a\" /* default */](log).save();\n/* harmony export (immutable) */ __webpack_exports__[\"c\"] = saveLog;\n\n\nconst deleteLog = async query => __WEBPACK_IMPORTED_MODULE_0__models_log__[\"a\" /* default */].remove(query).exec();\n/* harmony export (immutable) */ __webpack_exports__[\"a\"] = deleteLog;\n\n\nconst saveTime = async (query, updateObject) => __WEBPACK_IMPORTED_MODULE_0__models_log__[\"a\" /* default */].update(query, updateObject).exec();\n/* harmony export (immutable) */ __webpack_exports__[\"d\"] = saveTime;\n\n\n//////////////////\n// WEBPACK FOOTER\n// ./logic/components/log/db.js\n// module id = ./logic/components/log/db.js\n// module chunks = 0\n\n//# sourceURL=webpack:///./logic/components/log/db.js?");
