...
"use strict";
eval("/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mongoose__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mongoose___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mongoose__);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ramda__ = __webpack_require__(/*! ramda */ \"ramda\");\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ramda___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_ramda__);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setup_server__ = __webpack_require__(/*! ../setup/server */ \"./setup/server.js\");\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__db__ = __webpack_require__(/*! ./db */ \"./logic/db.js\");\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helper__ = __webpack_require__(/*! ./helper */ \"./logic/helper.js\");\n// modules\n\n\n// components\n\n// db helpers\n\n// helpers\n\n// const\nconst logger = console.log;\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/fetchUsers', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"f\" /* fetchUsers */])({ wis: req.query.wis }).then(users => res.json(users)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/fetchLogs', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])({ wis: req.query.wis, userId: req.query.userId, date: req.query.date }).then(logs => res.json(logs)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/fetchTags', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"e\" /* fetchTags */])({ wis: req.query.wis }).then(logs => res.json(logs)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/serachTags', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"e\" /* fetchTags */])({ wis: req.query.wis, userId: req.query.userId, label: { $regex: `.*${req.query.label}.*` } }).then(tags => res.json(tags)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/saveUser', (req, res) => {\n  Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"b\" /* countUser */])({ wis: req.body.wis, id: req.body.userId }).then(number => {\n    if (number === 0) {\n      Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"k\" /* saveUser */])({ wis: req.body.wis, name: req.body.username, id: req.body.userId }).then(() => res.send('saved successfully!')).catch(logger);\n    }\n    res.send('user was saved before!');\n  });\n});\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/saveLog', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"h\" /* saveLog */])(req.body).then(result => res.send(result)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/saveCustomLog', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"g\" /* saveCustomLog */])(req.body).then(log => res.send(log)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/saveTags', (req, res) => {\n  const addOrUpdateTag = tag => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"a\" /* countTags */])({ wis: req.body.wis, userId: req.query.userId, label: tag }).then(number => {\n    if (number === 0) {\n      Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"i\" /* saveTag */])({ label: tag, number: 1, userId: req.query.userId, wis: req.body.wis });\n    } else {\n      Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"l\" /* updateTag */])({ label: tag }, { $inc: { number: 1 } });\n    }\n  });\n  __WEBPACK_IMPORTED_MODULE_1_ramda__[\"forEach\"](addOrUpdateTag, req.body.tags);\n  Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"e\" /* fetchTags */])({ wis: req.body.wis, userId: req.query.userId }).then(tags => res.json(tags)).catch(logger);\n});\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/insertLogToNextDay', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"h\" /* saveLog */])(req.body).then(log => res.send(log)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/deleteLog', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"c\" /* deleteLog */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(req.query._id) }).then(() => res.send('deleted successfully!')).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/saveStartTime', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"j\" /* saveTime */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(req.body._id) }, { $push: { times: { start: req.body.startTime, end: 'running' } } }).then(() => res.send('deleted successfully!')).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/saveEndTime', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"j\" /* saveTime */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(req.body._id), 'times.end': 'running' }, { $set: { 'times.$.end': req.body.endTime } }).then(message => res.send(message)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/todayTotalDuration', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])({ wis: req.body.wis, userId: req.query.userId, date: req.body.date }).then(__WEBPACK_IMPORTED_MODULE_4__helper__[\"e\" /* sumLogs */]).then(sum => Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"a\" /* formattedSeconds */])(sum, 'Home')).then(totalDuration => res.send(totalDuration)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/thisWeekTotalDurations', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])({\n  wis: req.body.wis,\n  userId: req.query.userId,\n  $and: [{ date: { $gte: req.body.startDate } }, { date: { $lte: req.body.endDate } }] }).then(__WEBPACK_IMPORTED_MODULE_4__helper__[\"e\" /* sumLogs */]).then(sum => Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"a\" /* formattedSeconds */])(sum, 'Home')).then(totalDuration => res.send(totalDuration)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].post('/thisMonthTotalDurations', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])({\n  wis: req.body.wis,\n  userId: req.query.userId,\n  $and: [{ date: { $gte: req.body.startDate } }, { date: { $lte: req.body.endDate } }] }).then(__WEBPACK_IMPORTED_MODULE_4__helper__[\"e\" /* sumLogs */]).then(sum => Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"a\" /* formattedSeconds */])(sum, 'Home')).then(totalDuration => res.send(totalDuration)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/fetchPreviousDayData', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])({ wis: req.query.wis, userId: req.query.userId, date: req.query.date }).then(logs => res.json(logs)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/fetchNextDayData', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])({ wis: req.query.wis, userId: req.query.userId, date: req.query.date }).then(logs => res.json(logs)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/calculateTotalDuration', (req, res) => {\n  const query = Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"d\" /* modifiedQuery */])(req.query);\n  Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])(query, 'Report').then(__WEBPACK_IMPORTED_MODULE_4__helper__[\"e\" /* sumLogs */]).then(sum => Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"a\" /* formattedSeconds */])(sum, 'Report')).then(totalDuration => res.send(totalDuration)).catch(logger);\n});\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/convertJSONToCSV', (req, res) => {\n  const query = Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"d\" /* modifiedQuery */])(req.query);\n  Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])(query).then(logs => Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"c\" /* getJSON */])(logs)).then(csv => {\n    res.setHeader('Content-disposition', 'attachment; filename=data.csv');\n    res.set('Content-Type', 'text/csv');\n    res.status(200).send(csv);\n  }).catch(logger);\n});\n\n__WEBPACK_IMPORTED_MODULE_2__setup_server__[\"a\" /* default */].get('/barChartData', (req, res) => {\n  const query = {\n    wis: req.query.wis,\n    userId: req.query.userId,\n    $and: [{ date: { $gte: req.query.startDate } }, { date: { $lte: req.query.endDate } }]\n  };\n  Object(__WEBPACK_IMPORTED_MODULE_3__db__[\"d\" /* fetchLogs */])(query).then(logs => res.send(Object(__WEBPACK_IMPORTED_MODULE_4__helper__[\"b\" /* getBarChartData */])(logs, req.query))).catch(logger);\n});\n\n//////////////////\n// WEBPACK FOOTER\n// ./logic/route.js\n// module id = ./logic/route.js\n// module chunks = 0\n\n//# sourceURL=webpack:///./logic/route.js?");
