...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ramda */ \"ramda\");\n/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(ramda__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _setup_server__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../setup/server */ \"./setup/server.js\");\n/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./db */ \"./logic/components/log/db.js\");\n/* harmony import */ var _pin_db__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pin/db */ \"./logic/components/pin/db.js\");\n/* harmony import */ var _main_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../main/helper */ \"./logic/main/helper.js\");\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n// modules\n\n // components\n\n // db helpers\n\n\n // helpers\n\n // const\n\nconst logger = console.log;\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get(\"/fetchLogs\", ({\n  query: {\n    wis,\n    userId,\n    date\n  }\n}, res) => Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])({\n  wis,\n  userId,\n  date\n}).then(logs => res.json(ramda__WEBPACK_IMPORTED_MODULE_1__[\"reverse\"](logs))).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].post(\"/saveLog\", (req, res) => Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"saveLog\"])(_objectSpread({}, req.body, {\n  date: Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"formattedDate\"])(new Date()),\n  created_at: new Date()\n})).then(log => res.send(log)).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].post(\"/saveCustomLog\", (req, res) => Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"saveLog\"])(_objectSpread({}, req.body, {\n  created_at: new Date()\n})).then(log => res.send(log)).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].post(\"/insertLogToNextDay\", (req, res) => Promise.all([Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"saveLog\"])(_objectSpread({}, req.body, {\n  created_at: new Date()\n})), Object(_pin_db__WEBPACK_IMPORTED_MODULE_4__[\"fetchPins\"])(_objectSpread({}, Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"defaultQueryGenerator\"])(req.body)))]).then(success => res.json({\n  log: success[0],\n  pins: success[1]\n})).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].post(\"/deleteLog\", ({\n  query\n}, res) => Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"deleteLog\"])({\n  _id: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Types.ObjectId(query._id)\n}).then(() => res.send(query)).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].post(\"/saveStartTime\", ({\n  body\n}, res) => Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"saveTime\"])({\n  _id: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Types.ObjectId(body._id)\n}, {\n  $push: {\n    times: {\n      start: new Date(),\n      end: \"running\"\n    }\n  }\n}).then(() => res.send(_objectSpread({}, body, {\n  start: new Date()\n}))).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].post(\"/saveEndTime\", ({\n  body\n}, res) => Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"saveTime\"])({\n  _id: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Types.ObjectId(body.runningId),\n  \"times.end\": \"running\"\n}, {\n  $set: {\n    \"times.$.end\": body.end || new Date()\n  }\n}).then(() => res.send(_objectSpread({}, body, {\n  end: body.end || new Date()\n}))).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get(\"/fetchTotalDurations\", ({\n  query\n}, res) => Promise.all([Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])(_objectSpread({}, Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"defaultQueryGenerator\"])(query), {\n  date: query.today\n})), Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])(_objectSpread({}, Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"defaultQueryGenerator\"])(query), {\n  $and: [{\n    date: {\n      $gte: Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"getStartDayOfWeek\"])(query.today)\n    }\n  }, {\n    date: {\n      $lte: query.today\n    }\n  }]\n})), Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])(_objectSpread({}, Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"defaultQueryGenerator\"])(query), {\n  $and: [{\n    date: {\n      $gte: Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"getStartDayOfMonth\"])(query.today)\n    }\n  }, {\n    date: {\n      $lte: query.today\n    }\n  }]\n}))]).then(success => res.json({\n  today: Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"formattedSeconds\"])(Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"sumLogs\"])(success[0]), \"Home\"),\n  thisWeek: Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"formattedSeconds\"])(Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"sumLogs\"])(success[1]), \"Home\"),\n  thisMonth: Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"formattedSeconds\"])(Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"sumLogs\"])(success[2]), \"Home\")\n})).catch(logger));\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get(\"/calculateTotalDuration\", (req, res) => {\n  const query = Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"modifiedQuery\"])(req.query);\n  Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])(query, \"Report\").then(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"sumLogs\"]).then(sum => Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"formattedSeconds\"])(sum, \"Report\")).then(totalDuration => res.json(totalDuration)).catch(logger);\n});\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get(\"/convertJSONToCSV\", (req, res) => {\n  const query = Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"modifiedQuery\"])(req.query);\n  Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])(query).then(logs => Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"getJSON\"])(logs)).then(csv => {\n    res.setHeader(\"Content-disposition\", \"attachment; filename=data.csv\");\n    res.set(\"Content-Type\", \"text/csv\");\n    res.status(200).send(csv);\n  }).catch(logger);\n});\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get(\"/barChartData\", ({\n  query\n}, res) => {\n  const newQuery = {\n    wis: query.wis,\n    userId: query.userId,\n    $and: [{\n      date: {\n        $gte: query.startDate\n      }\n    }, {\n      date: {\n        $lte: query.endDate\n      }\n    }]\n  };\n  Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])(newQuery).then(logs => res.send(Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"getBarChartData\"])(logs, query))).catch(logger);\n});\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get(\"/leaderboardData\", ({\n  query\n}, res) => {\n  const newQuery = {\n    wis: query.wis,\n    $and: [{\n      date: {\n        $gte: query.startDate\n      }\n    }, {\n      date: {\n        $lte: query.endDate\n      }\n    }]\n  };\n  Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])(newQuery).then(logs => res.send(Object(_main_helper__WEBPACK_IMPORTED_MODULE_5__[\"getLeaderboardData\"])(logs))).catch(logger);\n});\n_setup_server__WEBPACK_IMPORTED_MODULE_2__[\"default\"].get(\"/getAnalysisData\", ({\n  query: {\n    wis,\n    userId\n  }\n}, res) => Object(_db__WEBPACK_IMPORTED_MODULE_3__[\"fetchLogs\"])({\n  wis\n}).then(logs => res.send(getAnalysisData(logs, userId))).catch(logger));\n\n//# sourceURL=webpack:///./logic/components/log/route.js?");
