...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"fetchLogs\", function() { return fetchLogs; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"saveLog\", function() { return saveLog; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"saveCustomLog\", function() { return saveCustomLog; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteLog\", function() { return deleteLog; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"saveTime\", function() { return saveTime; });\n/* harmony import */ var date_fns_format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns/format */ \"date-fns/format\");\n/* harmony import */ var date_fns_format__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(date_fns_format__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _models_log__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../models/log */ \"./models/log.js\");\n// modules\n\n// models\n\n\nconst fetchLogs = async query => _models_log__WEBPACK_IMPORTED_MODULE_1__[\"default\"].find(query).sort({ created_at: -1 }).exec();\n\nconst saveLog = async log => new _models_log__WEBPACK_IMPORTED_MODULE_1__[\"default\"](log).save();\n\nconst saveCustomLog = async log => new _models_log__WEBPACK_IMPORTED_MODULE_1__[\"default\"](log).save((err, result) => {\n  if (err) throw err;\n  if (result.date === date_fns_format__WEBPACK_IMPORTED_MODULE_0___default()(new Date(), 'YYYY-MM-DD')) return result;\n  return 'added successfully!';\n});\n\nconst deleteLog = async query => _models_log__WEBPACK_IMPORTED_MODULE_1__[\"default\"].remove(query).exec();\n\nconst saveTime = async (query, updateObject) => _models_log__WEBPACK_IMPORTED_MODULE_1__[\"default\"].update(query, updateObject).exec();\n\n//# sourceURL=webpack:///./logic/components/log/db.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _setup_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../setup/server */ \"./setup/server.js\");\n/* harmony import */ var _components_user_route__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/user/route */ \"./logic/components/user/route.js\");\n/* harmony import */ var _components_log_route__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/log/route */ \"./logic/components/log/route.js\");\n/* harmony import */ var _components_tag_route__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/tag/route */ \"./logic/components/tag/route.js\");\n/* harmony import */ var _components_log_db__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/log/db */ \"./logic/components/log/db.js\");\n/* harmony import */ var _components_tag_db__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/tag/db */ \"./logic/components/tag/db.js\");\n/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helper */ \"./logic/main/helper.js\");\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\n// components\n\n\n\n\n// db helpers\n\n\n// helpers\n\n// const\nconst logger = console.log;\n\n_setup_server__WEBPACK_IMPORTED_MODULE_0__[\"default\"].get('/initialFetch', ({ query }, res) => Promise.all([Object(_components_log_db__WEBPACK_IMPORTED_MODULE_4__[\"fetchLogs\"])(_extends({}, Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"defaultQueryGenerator\"])(query), {\n  $and: [{ date: { $gte: Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"getYesterday\"])(query.today) } }, { date: { $lte: query.today } }]\n})), Object(_components_tag_db__WEBPACK_IMPORTED_MODULE_5__[\"fetchTags\"])(_extends({}, Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"defaultQueryGenerator\"])(query))), Object(_components_log_db__WEBPACK_IMPORTED_MODULE_4__[\"fetchLogs\"])(_extends({}, Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"defaultQueryGenerator\"])(query), { date: query.today })), Object(_components_log_db__WEBPACK_IMPORTED_MODULE_4__[\"fetchLogs\"])(_extends({}, Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"defaultQueryGenerator\"])(query), {\n  $and: [{ date: { $gte: Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"getStartDayOfWeek\"])(query.today) } }, { date: { $lte: query.today } }]\n})), Object(_components_log_db__WEBPACK_IMPORTED_MODULE_4__[\"fetchLogs\"])(_extends({}, Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"defaultQueryGenerator\"])(query), {\n  $and: [{ date: { $gte: Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"getStartDayOfMonth\"])(query.today) } }, { date: { $lte: query.today } }]\n}))]).then(success => res.json({\n  logs: success[0],\n  tags: success[1],\n  totalDurations: {\n    today: Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"formattedSeconds\"])(Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"sumLogs\"])(success[2]), 'Home'),\n    thisWeek: Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"formattedSeconds\"])(Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"sumLogs\"])(success[3]), 'Home'),\n    thisMonth: Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"formattedSeconds\"])(Object(_helper__WEBPACK_IMPORTED_MODULE_6__[\"sumLogs\"])(success[4]), 'Home')\n  }\n})).catch(logger));\n\n//# sourceURL=webpack:///./logic/main/route.js?");
