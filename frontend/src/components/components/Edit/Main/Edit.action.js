...
export const ADD_TAG_IN_EDIT = 'ADD_TAG_IN_EDIT'
export const addTagInEdit = createAction(ADD_TAG_IN_EDIT)
export const dispatchAddTagInEdit = (...args) => dispatch(addTagInEdit(...args))
