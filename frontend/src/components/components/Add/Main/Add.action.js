...
export const setQueryInAdd = createAction(SET_QUERY_IN_ADD, queryTag => ({
  queryTag,
}))
export const dispatchSetQueryInAdd = (...args) =>
  dispatch(setQueryInAdd(...args))

export const FETCH_TAGS_IN_ADD = 'FETCH_TAGS_IN_ADD'
export const fetchTagsInAdd = createAction(FETCH_TAGS_IN_ADD, tags => ({
  tags,
}))
export const dispatchFetchTagsInAdd = (...args) =>
  dispatch(fetchTagsInAdd(...args))
...
export const changeStartTime = createAction(CHANGE_START_TIME, value => ({
  value,
}))
export const dispatchChangeStartTime = (...args) =>
  dispatch(changeStartTime(...args))

export const CHANGE_END_TIME = 'CHANGE_END_TIME'
export const changeEndTime = createAction(CHANGE_END_TIME, value => ({ value }))
export const dispatchChangeEndTime = (...args) =>
  dispatch(changeEndTime(...args))
...
export const dispatchLoadTagsDataInAdd = (...args) =>
  dispatch(loadTagsDataInAdd(...args))
...
export const changeSelectedTagsInAdd = createAction(
...
export const dispatchToggleExpanded = (...args) =>
  dispatch(toggleExpanded(...args))

export const CHANGE_IS_ERROR_IN_ADD = 'CHANGE_IS_ERROR_IN_ADD'
export const changeIsErrorInAdd = createAction(
  CHANGE_IS_ERROR_IN_ADD,
  value => ({ value }),
)
export const dispatchChangeIsErrorInAdd = (...args) =>
  dispatch(changeIsErrorInAdd(...args))
...
export const dispatchHandleAddTagInAdd = (...args) =>
  dispatch(handleAddTagInAdd(...args))

export const HANDLE_ADD_LOG = 'HANDLE_ADD_LOG'
export const handleAddLog = createAction(
  HANDLE_ADD_LOG,
  (title, tags, quickMode) => ({ title, tags, quickMode }),
)
